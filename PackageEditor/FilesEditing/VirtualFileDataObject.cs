...
namespace Delay
{
    ...
    public class VirtualFileDataObject : System.Runtime.InteropServices.ComTypes.IDataObject, IAsyncOperation
    {
        ...
        public static class NativeMethods
        {
            ...
            {
                public int pFiles;      //<-- offset to filelist (this should be defined 20)
                public POINT point;     //<-- where we "release the mouse button"
                public bool fNC;        //<-- the point origins (0;0) (this should be false, if true, the origin will be the screens (0;0), else, the handle the the window we send in PostMessage)
                public bool fWide;      //<-- ANSI or Unicode (should be true)           
            }
